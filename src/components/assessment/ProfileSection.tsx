...
export function ProfileSection({ title, subtitle, steps, sectionNumber, totalSections, initialAnswers = {}, onComplete }: ProfileSectionProps) {
    ...
    <div className="min-h-screen py-12 px-6 max-w-3xl mx-auto">
      ...
      <AnimatePresence mode="wait" custom={direction}>
        <motion.div key={current} custom={direction} variants={variants}
          ...
          <h2 className="font-serif text-[1.7rem] leading-[1.25] text-[#1C1C1E] mb-2">
            {step.question}
          </h2>
          {step.hint && (
            <p className="text-sm text-[#636366] font-light mb-6">{step.hint}</p>
          )}
